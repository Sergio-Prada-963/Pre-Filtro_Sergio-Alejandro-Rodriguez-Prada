...
<div className="content">
            ...
            <div className="info">
                ...
                <details>
                    ...
                    <p><span>PotenciaHP:</span> {newPotenciaHP}</p>
                    <p><span>Precio:</span> {newPrecio}</p>
                    <p><span>Tipo:</span> {newTipo}</p>
                    <p><span>Cilindraje:</span> {newCilindraje}</p>
                    <p><span>Año:</span> {newAno}</p>
