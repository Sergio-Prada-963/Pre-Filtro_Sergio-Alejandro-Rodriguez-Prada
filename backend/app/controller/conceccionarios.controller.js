...
export const postConceccionario = async (req,res)=>{
    try {
        ...
        const data = await collection.insertOne({Nombre, Ubicacion, Cantidad_ventas, Inventario});
...
export const updateConceccionario = async (req,res)=>{
    try {
        ...
        const data = await collection.updateOne({_id: new ObjectId(id)},{$set: {Nombre, Ubicacion, Cantidad_ventas, Inventario}});
